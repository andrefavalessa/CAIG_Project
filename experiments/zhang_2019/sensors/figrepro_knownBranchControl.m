...
% Conditional inversion: the unavailable branch labels are supplied externally.
caig.PhaseLoop1RecRad = ...
    externalLabels.sign1 .* caig.PhaseLoop1RecRad + 2 * pi * externalLabels.fringe1;
caig.PhaseLoop2RecRad = ...
    externalLabels.sign2 .* caig.PhaseLoop2RecRad + 2 * pi * externalLabels.fringe2;
